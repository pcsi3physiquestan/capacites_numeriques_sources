...
### Cas du régime libre
L'implémentation suivante est à bien comprendre et à savoir refaire sans guide. Elle est la base des intégrations numériques.
...
>     * (Initialisation) Créer deux __listes__ vide `tk` et `yk` dans lesquels on stockera les valeurs $t_k$ et $y_k$ puis ajouter à ces listes les conditions initiales $t_0$ et $y_0$. On prendra $y_0 = y(t_0) = 1 \rm{V}$ et $t_0 = 
